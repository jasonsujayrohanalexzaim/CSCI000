  ...
  return (
    <div className='container'>
      ...
      <main>
        ...
        <div className='grid'>
        <a href='/jason ' className='card'>
            <h3>Jason Gao &rarr;</h3>
            <p>Click here to navigate to an example page</p>
          </a>
          <a href='/sujay ' className='card'>
            <h3>Sujay Potlapelly &rarr;</h3>
            <p>Click here to navigate to an example page</p>
          </a>
          <a href='/rohan ' className='card'>
            <h3>Rohan Adepu &rarr;</h3>
            <p>Click here to navigate to an example page</p>
          </a>
